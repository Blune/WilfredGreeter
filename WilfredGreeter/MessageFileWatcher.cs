...
namespace WilfredGreeter
{
    public class MessageFileWatcher
    {
        ...
        public MessageFileWatcher(string networkPath, Action fileChangedAction)
        {
        ...
        private void _watcher_Changed(object sender, FileSystemEventArgs e) =>_fileChangedAction();
    }
}
